    ...
    var body: some View {
        ...
        return NavigationView {
            ZStack {
                ...
                .navigationBarTitle("已过期", displayMode: .inline)
            }
        }
    }
    func getDates() -> [Date] {
...
struct AllOverDueView_Previews: PreviewProvider {
    static var previews: some View {
        AllOverDueView(searchKey: .constant(""), sheet: .constant(nil), newDate: .constant(Date()))
    }
}
